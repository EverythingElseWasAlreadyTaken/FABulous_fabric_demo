# Based on: https://github.com/Digilent/digilent-xdc/blob/master/Nexys-Video-Master.xdc
#
...
set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS12 } [get_ports { reset }]; #IO_L24P_T3_16 Sch=sw[2]
...
## Pmod header JB
set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33 } [get_ports { s_clk }]; #IO_L21P_T3_DQS_34 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { s_data }]; #IO_L21N_T3_DQS_34 Sch=jb_n[1]
